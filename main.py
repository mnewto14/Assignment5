...
@app.get("/resources/{resources_id}", response_model=schemas.Resource, tags=["Resources"])
...
@app.get("/recipes/{order_detail_id}", response_model=schemas.OrderDetail, tags=["Recipes"])
